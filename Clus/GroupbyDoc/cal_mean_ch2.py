...
root_path = r'C:\Users\scaactk\Desktop\test'
for root, dir, files in os.walk(root_path):
    ...
    for item in files:
        ...
        if suffix == 'xlsx' and 'statistics' not in name and 'mean' not in name:
            ...
            if name.split('_')[-1] == 'Ch1': # only for channel 2
                continue
            ...
            number_of_nonclustered_events = 0
            ...
            for row in data.itertuples():
                if getattr(row, 'ClusterID') == 0:
                    ...
                    number_of_nonclustered_events += 1
            ...
            if number_of_nonclustered_events == 0:
                number_of_non_clustered_events = 1
            elif number_of_clustered_and_col_events == 0:
                number_of_clustered_and_col_events = 1
            elif number_of_clustered_and_noncol_events == 0:
                number_of_clustered_and_noncol_events = 1

            if channel == 1:
                mean_channel_1 = mean_channel_1.append({"ROI": ROI_number,
                                                        "mean_DoC_for_nonclustered_events": sum_of_nonclustered_events / number_of_nonclustered_events,
    ...
    output_name = root_path + '/' + 'mean_ch2.xlsx'
